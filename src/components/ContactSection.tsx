...
const contactLinks = [
  {
    icon: Mail,
    label: "Email",
    value: "sohambamane23@gmail.com",
    href: "mailto:sohambamane23@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 93095 13254",
    href: "tel:+919309513254",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "linkedin.com/in/sohambamane",
    href: "https://linkedin.com/in/sohambamane",
  },
  {
    icon: Github,
    label: "GitHub",
    value: "github.com/sohambamane",
        ...
        <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
          {contactLinks.map((link, i) => (
            <motion.a
              ...
              className="glass-card p-6 flex items-center gap-4 group hover-glow"
            >
